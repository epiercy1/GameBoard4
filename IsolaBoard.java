...
public class IsolaBoard {
	private BoardSpace []
			...
			board[0]
			[startColumn] = BoardSpace.Player1;
			 
			board[height-1]
			[startColumn] = BoardSpace.Player2;
